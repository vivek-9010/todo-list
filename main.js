...
class UIManager {
  constructor(todoManager, todoItemFormatter) {
    ...
    this.todosListBody = document.querySelector(".todos-list-body") || this.createTableBody();
  ...
  createTableBody() {
    ...
    tbody.classList.add("todos-list-body");
  ...
  displayTodos(todos) {
    ...
    todos.forEach((todo) => {
      ...
      editBtn.innerHTML = `<i class="bx bx-edit-alt bx-xs"></i>`;
      editBtn.onclick = () => this.handleEditTodo(todo.id);

      const toggleBtn = document.createElement("button");
      toggleBtn.className = "btn btn-success btn-sm";
      toggleBtn.innerHTML = `<i class="bx bx-check bx-xs"></i>`;
      toggleBtn.onclick = () => this.handleToggleStatus(todo.id);

      const deleteBtn = document.createElement("button");
      deleteBtn.className = "btn btn-error btn-sm";
      deleteBtn.innerHTML = `<i class="bx bx-trash bx-xs"></i>`;
      deleteBtn.onclick = () => this.handleDeleteTodo(todo.id);

      actionsTd.append(editBtn, toggleBtn, deleteBtn);
      this.todosListBody.appendChild(tr);
    });
  }
